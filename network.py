...
class NeuralNetwork(object):
    ...
    def fit(self, training_data, validation_data=None):
        ...
        Parameters
        ----------
        training_data : tuple of list
            A tuple of numpy arrays, ordered as (images, labels).

        validation_data : tuple of list, optional
    ...
    def print_progress(self, validation_data, epoch):
        """add documentation
        """
        if validation_data:
